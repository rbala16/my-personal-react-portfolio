...
const ResumeCard = ({ title, subTitle, result, des }) => {
  return (
    <div className="w-full h-1/3 group flex">
      ...
      rounded-lg lgl:px-10 p-4 flex flex-col justify-center gap-6 lgl:gap-10 shadow-shadowOne"
      >
        <div className="flex flex-col lgl:flex-row justify-between gap-4 lgl:gap-0 lgl:items-center">
          ...
          <div>
            <p
              className="px-4 py-2 text-designColor bg-black bg-opacity-25 rounded-lg flex justify-center
